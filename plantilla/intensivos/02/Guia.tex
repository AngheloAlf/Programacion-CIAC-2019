...
\pagebreak % pone el resto del documento en la siguiente pagina
% prueba a quitarlo y compilar denuevo


\input{Guia/pregunta02.tex}
% \input{Guia/pregunta03.tex} % Descomentar para agregar otras preguntas
