...
\lstinputlisting[style=mypy,caption=\texttt{impuesto.py}]{Code/impuesto.py}
\newpage
\section{Concurso de clavados}

\lstinputlisting[style=mypy,caption=\texttt{clavados.py}]{Code/clavados.py}
