...
\chead{
  Evaluación formativa \textit{Online}  N° 4\\
...
%DeclareFloatingEnvironment[placement=H,name=Output]{outFloat}
%\newcounter{outcode}
%\newenvironment{outcode}[3]{
    %\begin{outFloat}
    %    \lstinputlisting[style = whiteConsole, firstline = {#2}, firstnumber = {#2}, lastline = {#3}]{#1}
%}{\addtocounter{outcode}{1}}
%\end{outFloat}
