...
\section{Primos, compuestos y proyecto Euler}
  ...
  \lstinputlisting[
    style  = mypy,
    caption= \texttt{projecteuler10.py}]{Code/primos.py}
\newpage
\section{Resistencias equivalentes}
  ...
  \lstinputlisting[
    style  = mypy,
    caption= \texttt{resistencias.py}]{Code/resistencias.py}
...
\section{El supermercado CIAC}
  ...
  \lstinputlisting[
    style  = mypy,
    caption= \texttt{supermercado.py}]{Code/ventas.py}
