...
\section{Teclado de celular}
\lstinputlisting[style=mypy,caption=\texttt{celular.py}]{Code/celularpauta.py}
\pagebreak[4]
\section{Sopa de letras}
\lstinputlisting[style=mypy,caption=\texttt{sopa.py}]{Code/sopa.py}
\section{Autos}
\lstinputlisting[style=mypy,caption=\texttt{autos.py}]{Code/autos.py}
\newpage
\section{Juegos}
\lstinputlisting[style=mypy,caption=\texttt{juegos.py}]{Code/juegos.py}
\end{document}
