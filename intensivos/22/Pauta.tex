...
\section{Triángulo y máxima suma de ruta}
\lstinputlisting[style=mypy,caption=\texttt{triangulo.py}]{Code/triangulo.py}
\section{Aeropuerto}
\lstinputlisting[style=mypy,caption=\texttt{aeropuerto.py}]{Code/aeropuerto.py}
\end{document}
