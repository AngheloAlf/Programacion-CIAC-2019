...
\lstinputlisting[
    style  = mypy,
    caption= \texttt{peliculandia.py}]{Code/peliculandia.py}
\newpage
...
Agregar a mickey miguel a Fortnite

\lstinputlisting[
    style  = mypy,
    caption= \texttt{resumen.py}]{Code/resumen.py}
    
\section{Una de certamen antiguo - PyDI}

El sábado 24 de agosto a las 14 horas vendré a estudiar a CIAC, y mis consultas las haré al correo\\ \texttt{miguel.godoy.13@sansano.usm.cl}
\lstinputlisting[
    style  = mypy,
    caption= \texttt{terroristas.py}]{Code/terroristas.py}
