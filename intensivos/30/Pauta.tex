...
\section{Banco de animales}
    ...
    \lstinputlisting[
    style = mypy,
    caption = \texttt{animales.py}]{Code/animales.py}
    
\section{Autopista}

    \lstinputlisting[
    style = mypy,
    caption = \texttt{autopista.py}]{Code/autopista.py}
%\newpage
\section{Etiquetado}
    \lstinputlisting[
    style = mypy,
    caption = \texttt{etiquetado.py}]{Code/etiquetado.py}
\newpage
\section{Cosecha}
    \lstinputlisting[
    style = mypy,
    caption = \texttt{cosecha.py}]{Code/cosecha.py}
\end{document}